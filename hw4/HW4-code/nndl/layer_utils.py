...
def affine_batchnorm_forward(x, w, b, gamma, beta, alpha): #batchnorm parameter -> alpha  
    
    affine_out, affine_cache = affine_forward(x, w, b)
    batchnorm_out, batchnorm_cache = batchnorm_forward(affine_out, gamma, beta, alpha) 
    
    y, rcache = relu_forward(batchnorm_out) #y is what we return, also y = gamma*x + beta
