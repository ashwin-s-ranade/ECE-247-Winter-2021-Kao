...
def sgd_momentum(w, dw, config=None):
  ...
  #adapted from lecture 10 slides, the slide titled "Momentum", also page 296 of the deep learning textbook
...
def rmsprop(w, dw, config=None):
  ...
  #using https://cs231n.github.io/neural-networks-3/#sgd as a guide, along w lecture slides 
  #a = cache 
