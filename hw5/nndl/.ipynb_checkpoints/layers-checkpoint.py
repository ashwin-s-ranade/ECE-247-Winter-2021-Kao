...
def relu_backward(dout, cache):
  ...
  dx = dout * (x >= 0) #otherwise got errors in implementation of cascaded layers
  # ================================================================ #
  # END YOUR CODE HERE
  # ================================================================ #
...
def batchnorm_forward(x, gamma, beta, bn_param):
  ...
  N, D = x.shape
  running_mean = bn_param.get('running_mean', np.zeros(D, dtype=x.dtype)) #key, value to be returned if key is not found
  ...
  if mode == 'train':
    ...
    #     (2) Normalize the activations with the sample mean and variance. (changed running -> sample)
    ...
    #step 2 -- normalize with the *sample* mean and variance (Piazza @368) [what does this mean?]
    ...
    cache = (gamma, beta, running_var, running_mean, mu, sigma_squared, x, eps, xhat)
    # ================================================================ #
    # END YOUR CODE HERE
    # ================================================================ #
  elif mode == 'test':
...
def batchnorm_backward(dout, cache):
  ...
  # ================================================================ #
  gamma, beta, running_var, running_mean, mu, sigma_squared, x, eps, xhat = cache #tuple unpacking
...
def dropout_forward(x, dropout_param):
  ...
  if mode == 'train':
    ...
    out = mask * x #commutative since * in numpy is the Hadamard product (entry wise) 
