...
class SVM(object):
  ...
  def loss(self, X, y):
    ...
    #using https://mlxai.github.io/2017/01/06/vectorized-implementation-of-svm-loss-and-gradient-update.html for a reference (Piazza @200)
        ...
        for j in np.arange(num_classes): 
            ...
            if j == y[i]: 
                continue
            loss += max(0, scores[j] - correct_class_score + 1) #delta = 1 in this case
  ...
  def loss_and_grad(self, X, y):
    ...
    # ================================================================ #
        ...
        for j in np.arange(num_classes): 
            ...
            if j == y[i]: 
                continue
            #delta = 1 in this case; according to https://cs231n.github.io/linear-classify/, it should always be 1? 
  ...
  def fast_loss_and_grad(self, X, y):
    ...
    margins = np.maximum(0, (scores.T - np.matrix(yi_scores)).T + 1) #delta = 1 always
    ...
    # ================================================================ #
     #use Guangyuan's discussion as reference:https://colab.research.google.com/drive/1ugOJc2qZHMQYh2sKf3QXz9-QbH5t5FIW and the other reference mentioned above
